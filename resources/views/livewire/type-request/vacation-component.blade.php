<div>
    <form method="POST" wire:submit.prevent="submit">
        ...
        <div class="col-md-12 mb-3 p-0">
            <label for="periodName">Nombre del perido vacacional</label>
            <input type="test" name="periodName" id="periodName" wire:model="periodName"
                class="form-control @error('periodName') is-invalid @enderror">
            @error('periodName')
