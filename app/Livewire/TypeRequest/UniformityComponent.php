...
use App\Services\UniformityService;

class UniformityComponent extends Component
{
    ...
    public function submit()
    {
        ...
        $message = (new UniformityService())->run($this->all())
    ...
    {
        return view('livewire.type-request.uniformity-component');
    }
}
